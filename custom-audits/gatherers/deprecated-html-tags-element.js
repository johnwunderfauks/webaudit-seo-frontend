...
class DeprecatedHTMLElements extends Gatherer {
	/**
	...
	async afterPass(options, loadData) {
		...
		const mainFn = () => {
			...
			*/
			...
			const tagNamesToCheck = ['acronym', 'applet', 'basefont', 'big', 'blink', 'center', 'dir', 'embed', 'font', 'frame', 'frameset', 'isindex', 'noframes', 'marquee', 'menu', 'plaintext', 's', 'strike', 'tt', 'u'];
...
module.exports = DeprecatedHTMLElements;